...
if nargin<5 || isempty(margins), margins = [0.04 0.04 0.04 0.04]; end %LTRB
...
ax = axes('Position', [(1/numcols)*(col-1)+margins(1)  1-margins(2)-height*row+spacing(2)  width-spacing(1) height-spacing(2)]);
box on, axis tight
if row < numrows
