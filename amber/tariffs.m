...
data = {
    ...
    "2024-07-01" "AGL SK"           113.916 [ 1  6 10 15] [38.4340  52.1510  34.9580  52.1510 ] [0      ] [ -4    ] inf 0         0        ''       % 2024 only
    "2024-01-01" "AGL RM"           115.060 [ 1  6 10 15] [40.9310  55.7150  37.0590  55.7150 ] [0      ] [-12    ] inf 0         0        ''       % hacked start time
    "2025-06-23" "AGL RM"           109.197 [ 1  6 10 15] [34.1440  49.016   29.4690  49.016  ] [0      ] [-10    ] inf 0         0        ''
    "2024-01-01" "EA LL"            106.913 [0          ] [51.8487                            ] [0      ] [  0    ] inf 0         0        ''
    "2024-01-01" "GlowBird"         106.913 [0          ] [34                                 ] [0      ] [  0    ] inf 0         0        ''
    "2024-01-01" "FOUR4FREE"        144.045 [ 1  6 10 14] [33.077    54.417    0       54.417 ] [0      ] [  0    ] inf 0         0        ''
    "2024-01-01" "Momentum HomeRun" 170.06  [ 1  6 10 15] [31.35     40.04    27.17    40.04  ] [0      ] [  2.5  ] inf 0         0        ''
    };
...
switch lower(T.rrp_source{1})
    case '' % do not add whole sale prices

    case {'nsw' 'qld' 'sa' 'tas' 'vic'} % Add wholesale prices from AMEO and apply Amber fees
    ...
    case 'amber' % Get wholesale prices from Amber with fees
