NEM12 is a CSV format specified by the Australian National Electricity Market (NEM)
It is used by electricity distributors to provide customer smart meter data via online portals.
https://support.solarquotes.com.au/hc/en-us/articles/360001312176-How-Do-I-Access-my-Smart-Meter-Data

CAUTION: This data is a bit personal. It can show when you are home, and has your meter's NMI number.

Instruction to manually download NEM12 usage data from SA Power Network (SAPN).
1. Find an old electricity bill, note the NMI number (~11 digit), and any meter number (~9 digit).
2. Go to power SA login page, register using any email address.
